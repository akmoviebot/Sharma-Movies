...
PICS = (environ.get('PICS', 'https://postimg.cc/5X6znjR7')).split() #SAMPLE PIC
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002489054339') # give your force subscribe channel id here else leave it blank
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sv6019244:sandhu0123@cluster0.chuysmh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+TNl5DApmlz04Mzll')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MovieupdatewithAK01')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MovieWalaClub') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '9deac3bf344cd8a3724e99f0af8c87e13079cb01')
